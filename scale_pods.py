...
pods = [
    "hom-apps-ca-se",
    "api-base-unica-hom",
    "hom-apibuscabureaupj",
    "api-pessoa-depara-hom",
    "app-senac-dev",
    "app-senac-hom",
    "hom-ms-bu-atualiza-chave",
    "hom-bu-buscar-depara",
    "hom-bu-buscar-pessoa",
    "hom-ms-bu-calcula-sexo",
    "hom-ms-bu-cidades",
    "hom-bu-api-consul-bureau",
    "hom-bu-api-consulta-cpf",
    "hom-bu-api-deduplicar-pessoa",
    "hom-bu-api-normaliz-nome",
    "hom-ms-bu-processo-seletivo",
    "hom-ms-validar-cpf-CNPJ",
    "hom-bu-historicos-cursos",
    "blog-eventos-hom",
    "mysqladmin",
    "camunda-hom",
    "hcard-hom",
    "dcentral-docs",
    "dcentral-docs-ms",
    "dupload-central-docs",
    "hcentral-docs",
    "hcentral-docs-ms",
    "hom-mongodb-community-6",
    "hupload-central-docs",
    "hom-integracao-portal-cf",
    "hom-colex",
    "hom-cont-crachas-front",
    "hom-controle-crachas-services",
    "hom-controle-seg-front",
    "hom-bu-api-pessoa",
    "hom-ms-registrar-interacao",
    "hom-dados-vestibular",
    "dsp-api-dev",
    "dsp-cms-dev",
    "nginx-dsp-dev",
    "hom-elasticsearch-ged-repositorio",
    "hom-ged-api",
    "hom-ged-front",
    "hom-ged-web",
    "hom-kibana-ged",
    "arquivo-server-graduacao",
    "hom-aprovacao-homologacao",
    "hom-lotacao-de-pessoal",
    "matricula-corporativa-hom",
]
